#!/usr/bin/env python3
"""
JSON-LD generators for four useful Schema.org types:
...
def profile(
    ...
    *,
    ...
    sameAs + knowsAbout can help disambiguate an entity across knowledge
    graphs. Relevant profile URLs such as GitHub, LinkedIn, and ORCID may be
    included when they are accurate and user-approved.
    """
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Schema.org JSON-LD generators for selected useful types."
    )
    parser.add_argument(
