...
Uses the autoseo color palette for severity-coded cards.
...
<body>
    ...
    <div class="footer">
        Generated by AutoSEO Drift Monitor | {report_time}
    </div>
</body>
</html>"""
...
def main():
    ...
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Allow replacement of an existing HTML report",
    )
    ...
    if args.stdin:
        ...
        try:
            raw = read_text_limited(args.file, extensions={".json"})
