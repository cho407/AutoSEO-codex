...
Usage::
    ...
    python scripts/autoseo_updates.py                  # latest 10
    python scripts/autoseo_updates.py --since 2025-06  # ISO yyyy or yyyy-mm filter
    python scripts/autoseo_updates.py --kind core
    python scripts/autoseo_updates.py --json
    python scripts/autoseo_updates.py --unverified     # show 3rd-party claims awaiting check
"""
