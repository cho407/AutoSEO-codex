...
try:
    ...
    print("Error: google_auth.py required in scripts/", file=sys.stderr)
    sys.exit(1)

from url_safety import URLSafetyError, read_limited_response  # noqa: E402

MAX_PSI_RESPONSE_BYTES = 100 * 1024 * 1024
...
def run_pagespeed(
    ...
    try:
        ...
        read_limited_response(resp, max_bytes=MAX_PSI_RESPONSE_BYTES)
...
def query_crux(
    ...
    try:
        ...
        read_limited_response(resp, max_bytes=MAX_CRUX_RESPONSE_BYTES)
