...
- **Cross-ref**: `@autoseo technical <url>`
...
- **Cross-ref**: `@autoseo google psi <url>`
...
- **Action**: Positive change. Validate the new schema with `@autoseo schema <url>`.
- **Cross-ref**: `@autoseo schema <url>`
