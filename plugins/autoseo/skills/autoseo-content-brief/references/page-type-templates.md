...
**Schema:** WebPage. Google retired FAQ rich results for all sites on May 7, 2026, and no AI or ranking benefit is confirmed. Use QAPage only when users can submit answers to a single question. See the autoseo-schema skill for the canonical position.
